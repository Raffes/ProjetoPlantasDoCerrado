...
include 'php/SelectFormularioPlanta.php';
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-md-6">
                <form id='checkout-form' class='clearfix' action='php/cadastroDasPlantas.php' method='POST'>
                    <table id='fichamento1'>
                        ...
                        <tr class='size-option'>
                            <td class='form-group'>
                                <select class='input search-categories'  id="formSelect" name='nomeCientificoPlanta'>
                            ...
                            <td class='form-group'>
                                <input class='input search-input' name='nomePopular' id="formSelect" type='text' placeholder='Nome Popular'>
                            </td>                                                                                 

                        </tr>
                        <tr>
                            <td id="selectForm" style='display:none;'><input class='input search-input' name='nomeCientificoPlanta' id="selectForm" type='text' placeholder='Nome Científico'></td>
                        </tr>
