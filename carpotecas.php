                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="billing-details">
                                                                        ...
                                                                        <?php
                                                                        $feed = "SELECT a.nomeCientificoCarpoteca, b.img1 FROM carpoteca as a inner join imagemCarpoteca as b on a.id = b.id LIMIT 5";
